...
public class CloudWatch {
	...
	public static void main(String[] args) {
		...
		final String awsAccessKey = "AKIAILV4QDH3G3CBPOVQ";
		final String awsSecretKey = "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";
		final String instanceId = "i-06dd7037ce7a4c836"; // i-0351a77671a0f4d61
	...
	private static GetMetricStatisticsRequest request(final String instanceId) {
		...
		return new GetMetricStatisticsRequest().withStartTime(new Date(new Date().getTime() - twentyFourHrs))
				.withNamespace("AWS/EC2").withPeriod(5)
