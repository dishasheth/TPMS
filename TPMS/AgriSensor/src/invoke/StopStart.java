...
public class StopStart {
	...
	public void startSensor(String user_id, String sensor_id) throws InterruptedException {
		...
		if (state.equals("running")) {
			...
			String query1 = "SELECT latitude,longitude from sensor_master where user_id='" + user_id
			...
			String query = "UPDATE `system272`.`sensor_master` SET `sensor_status`='Running' WHERE `sensor_id`='"
					+ sensor_id + "';";
