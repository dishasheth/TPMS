...
public class Charts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String q = "SELECT sensor_id FROM system272.sensor_master where user_id=" + id;
	...
	private ArrayList<ArrayList<Double>> getTempDetails(ArrayList<String> sensor_ids, ArrayList<String> dates)
		...
		for (int i = 0; i < sensor_ids.size(); i++) {
			...
			String query = "SELECT time_stamp, AVG(temp) as avgtemp FROM system272.temp_data where sensor_id='"
					+ sensor_ids.get(i) + "' group by CAST(time_stamp AS date) order by time_stamp DESC limit 15";
